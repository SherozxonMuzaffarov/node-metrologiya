        ...
        <BTableSimple striped="true" hover="true" bordered="true" class="mt-4">
            ...
            <BTbody>
                <BTr v-for="item in Data" :key="item.id" >
                    ...
                    <BTd>
                        <BButton v-b-toggle="item.name" class="w-100 text-start" variant="white">
                            {{ item.name }}
                        </BButton>
                        <!-- Element to collapse (Malumotlar) -->
                        <BCollapse :id="item.name" class="mt-1">
                            <div class="card p-1">
                                <BButton variant="outline-link m-0">
                                    <ol>
                                        <li v-for="depo in item.depo" class="text-start">
                                            {{ depo.name }}
                                        </li>
                                    </ol>
                                </BButton>
